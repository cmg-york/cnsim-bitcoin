...
class HonestNodeTest {
	...
	/** 
	 * Tries to reproduce cases in which the node validates a node but the pool is conflicting.  
	 * 
	 */
	@Test
	...
	void testBlockManagement() {
    	...
    	TestTutorial.step("# Blockchain#testBelief Test Tutorial: Block Management");
